...
<div class="container web-head">
    <div class="row tag-row-head">
        ...
        <div class="col head-titel">
            <h1 style="font-size: 50px;"><strong>{{$newsdata->article_title}}</strong></h1>
            <hr style="margin: 0;">
            <p style="margin: 0px;">Author: {{$newsdata->author_name}}</p>
            <p style="margin: 0px;">{{$newsdata->author_email}}</p>
  ...
  <div class=" container vstack  start-div img-container" style="background-image: url('{{ asset('storage/'.$newsdata->article_head_img) }}')">
